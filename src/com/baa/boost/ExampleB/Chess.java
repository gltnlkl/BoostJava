...
import com.baa.boost.java.course01.util.BAUtils;

public class Chess {

	public static void main(String[] args) {
		BAUtils.header("At�n Hareketleri");
		...
		do {
			...
			System.out.println("\n\n");
			printBoard(board);
		} while (BAUtils.wantToEnd("Devam etmek ister misiniz?", "Hay�r"));
	...
	private static Position readPosition() {		
		...
		do {
			String inp = BAUtils.readString("At�n pozisyonunu e4 gibi veriniz");
			inp = inp.toLowerCase();
