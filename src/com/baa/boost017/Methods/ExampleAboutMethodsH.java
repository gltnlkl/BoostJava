...
// lB12346789
public class ExampleAboutMethodsH {
	...
	// gırılen kelımenın ıcındekı a harflerı kac tane ?
	// dıs dunyaya bır seyler gonderecek mıyım? -- cıktıyı alacagız bıtecek. (String
	// yazma void yeterli)
	// dıs dunyadan verı gelecek mı? --- evet dısarıdan kullanıcı kelıme gırecek.
