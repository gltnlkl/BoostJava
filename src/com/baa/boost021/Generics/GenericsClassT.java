...
public class GenericsClassT<T> { // --->> <> ıle generıc class a donustu
	...
	private T adi; // private yazdıgımız ıcın bu sekıle getter ve setter ıle erıstık (satoya gırmek
	...
	public GenericsClassT(String adi, String soyadi) {
		// super();
		this.adi = adi;
		this.soyadi = soyadi;
	}
