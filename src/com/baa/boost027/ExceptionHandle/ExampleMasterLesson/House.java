...
public class House extends Realty {
	...
	public void setPrice(double price) {  // bu gereksiz. zaten realty'nin setPrice'� public oldu�undan her herde �a��rabilirdim
		super.setPrice(price);			  // sadece super kullan�m�na �rnek olsun diye
	}
