...
public class BeautyShop extends Common implements Area {
	...
	public BeautyShop(String storeName, String storeProductType, double price, LocalDate logDate, int commonId,
	...
	public String toString() {
		return "BeautyShop [location=" + location + ", dimension=" + dimension + ", getStoreName()=" + getStoreName()
